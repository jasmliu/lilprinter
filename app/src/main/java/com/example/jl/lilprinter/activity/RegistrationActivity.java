...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button loginButton = (Button) findViewById(R.id.btn_regLogin);
        loginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText usernameEdit = (EditText) findViewById(R.id.editTxt_regUsername);
                EditText passwordEdit = (EditText) findViewById(R.id.editTxt_regPassword);
