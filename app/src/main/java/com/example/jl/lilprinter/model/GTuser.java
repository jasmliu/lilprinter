...
public class GTuser extends User {
    ...
    public void updateInkStatus(Printer printer, boolean inkStatus) {
        printer.setInkStatus(boolean inkStatus);
    }

    public void updateJamStatus(Printer printer, boolean paperStatus) {
        printer.setPaperStatus(boolean paperStatus);
    }
